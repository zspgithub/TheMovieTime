 ...
 * 
 */
public class PayticketReyingBean {
    private String t;
    private String id;
    private String r;
    private String cC;
    ...
    private String NearestCinemaCount;
    private String NearestShowtimeCount;
    private String isTicket;
    private String isIMAX;
    private String is3D;
    private String isDMAX;
    private String rd;
    ...
    public void setWantedCount(String wantedCount) {
    ...
    public String getNearestCinemaCount() {
        return NearestCinemaCount;
    }

    public void setNearestCinemaCount(String nearestCinemaCount) {
    ...
    public String getIsDMAX() {
        return isDMAX;
    }

    public void setIsDMAX(String isDMAX) {
        this.isDMAX = isDMAX;
    }
