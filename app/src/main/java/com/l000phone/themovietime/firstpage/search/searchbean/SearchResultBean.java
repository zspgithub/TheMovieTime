...
public class SearchResultBean {
    ...
    public String[] getTitleOthersCn() {
        return titleOthersCn;
    }

    public void setTitleOthersCn(String[] titleOthersCn) {
        this.titleOthersCn = titleOthersCn;
    }
}
